...
# Setup
# ------------------------
os.makedirs("output_a100", exist_ok=True)
...
# Data Preparation
# ------------------------
dataset = XeniumCellDataset("data/demo/gene_expression", "data/demo/images", transform=transform)
...
log_path = os.path.join("output_a100", "train_log.csv")
...
for epoch in range(1, epochs + 1):
    ...
    if avg_val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), os.path.join("output_a100", "best_model.pt"))
