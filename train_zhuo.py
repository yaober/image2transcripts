...
# Setup
# ------------------------
os.makedirs("/archive/DPDS/Xiao_lab/shared/Zhuo_Zhao/output_188", exist_ok=True)
...
log_path = os.path.join("/archive/DPDS/Xiao_lab/shared/Zhuo_Zhao/output_188", "train_log.csv")
...
for epoch in range(1, epochs + 1):
    ...
    if avg_val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), os.path.join("/archive/DPDS/Xiao_lab/shared/Zhuo_Zhao/output_188", "best_model.pt"))
